...
htmlhelp_basename = 'layerstackdoc'
...
latex_documents = [
    (master_doc, 'layerstack.tex', 'layerstack Documentation',
     'Elaine Hale, Michael Rossol', 'manual'),
]
...
man_pages = [
    (master_doc, 'layerstack', 'layerstack Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'layerstack', 'layerstack Documentation',
     author, 'layerstack', 'One line description of project.',
     'Miscellaneous'),
]
